...
export const modules = [
    {
        ...
        type: 'Specific',
        path: '/apps/accounts-receivable/customer-invoices/generate',
        icon: 'Receipt',
    ...
    },
    {
        ...
        name: 'AR Aging',
        type: 'General',
        path: '/apps/accounts-receivable/customer-invoices/aging',
        icon: 'Schedule',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/accounts-receivable/customer-invoices/revenue',
        icon: 'Analytics',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/accounts-receivable/customer-invoices/dunning',
        icon: 'Warning',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/accounts-receivable/customer-invoices/disputes',
        icon: 'ReportProblem',
