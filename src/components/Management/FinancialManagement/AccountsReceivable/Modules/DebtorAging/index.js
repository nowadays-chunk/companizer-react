...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/accounts-receivable/debtor-aging/dashboard',
        icon: 'Dashboard',
    ...
    },
    {
        ...
        name: 'Aging Analysis',
        type: 'General',
        path: '/financial-management/accounts-receivable/debtor-aging/analysis',
        icon: 'Analytics',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/accounts-receivable/debtor-aging/risk',
        icon: 'WarningAmber',
    ...
    },
    {
        ...
        name: 'Cash Forecast',
        type: 'General',
        path: '/financial-management/accounts-receivable/debtor-aging/forecast',
        icon: 'ShowChart',
    ...
    },
    {
        ...
        name: 'Configuration',
        type: 'General',
        path: '/financial-management/accounts-receivable/debtor-aging/configuration',
        icon: 'Settings',
