...
export const modules = [
    {
        ...
        type: 'General',
        path: '/apps/accounts-receivable/credit-management/dashboard',
        icon: 'Dashboard',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/accounts-receivable/credit-management/profiles',
        icon: 'AccountBox',
    ...
    },
    {
        ...
        name: 'Risk Engine',
        type: 'General',
        path: '/apps/accounts-receivable/credit-management/risk-engine',
        icon: 'Psychology',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/accounts-receivable/credit-management/exposure',
        icon: 'TrendingDown',
    ...
    },
    {
        ...
        name: 'Governance',
        type: 'General',
        path: '/apps/accounts-receivable/credit-management/governance',
        icon: 'Gavel',
