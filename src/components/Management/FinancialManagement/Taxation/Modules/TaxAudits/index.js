...
export const modules = [
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/tax-audits/cases',
        icon: 'FolderShared',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/tax-audits/documents',
        icon: 'SnippetFolder',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/tax-audits/requests',
        icon: 'QuestionAnswer',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/tax-audits/findings',
        icon: 'FindInPage',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/tax-audits/penalties',
        icon: 'Gavel',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/tax-audits/appeals',
        icon: 'Balance',
    ...
    },
    {
        ...
        name: 'GL Integration',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/accounting',
        icon: 'AccountBalance',
    ...
    },
    {
        ...
        name: 'Audit Trail',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/history',
        icon: 'History',
    ...
    },
    {
        ...
        name: 'Consolidation',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/consolidation',
        icon: 'Compress',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/tax-audits/analytics',
        icon: 'Analytics',
    ...
    },
    {
        ...
        name: 'Workflows',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/workflow',
        icon: 'LinearScale',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/tax-audits/integration',
        icon: 'Hub',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/tax-audits/deadlines',
        icon: 'Event',
    ...
    },
    {
        ...
        name: 'Risk Control',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/risk',
        icon: 'Shield',
    ...
    },
    {
        ...
        name: 'Security',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/security',
        icon: 'Security',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/tax-audits/dashboard',
        icon: 'Dashboard',
    ...
    },
    {
        ...
        name: 'Automation',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/automation',
        icon: 'SmartToy',
    ...
    },
    {
        ...
        name: 'Data Integrity',
        type: 'General',
        path: '/financial-management/taxation/tax-audits/integrity',
        icon: 'VerifiedUser',
