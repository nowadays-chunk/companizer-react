...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/master-data',
        icon: 'Storage',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/counterparty',
        icon: 'AssignmentInd',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/calculation',
        icon: 'Calculate',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/integration',
    ...
    },
    {
        ...
        name: 'Accounting & GL',
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/accounting',
        icon: 'AccountBalance',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/certificates',
        icon: 'CardMembership',
    ...
    },
    {
        ...
        name: 'Tax Filing',
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/filing',
        icon: 'Description',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/remittance',
        icon: 'Payment',
    ...
    },
    {
        ...
        name: 'Reconciliation',
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/reconciliation',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/adjustments',
        icon: 'Edit',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/workflow/:id',
        icon: 'ThumbUp',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/taxation/withholding-taxes/status/:id',
        icon: 'TrackChanges',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/treaty',
        icon: 'Public',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/analytics',
        icon: 'Analytics',
    ...
    },
    {
        ...
        name: 'Rules Engine',
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/rules',
        icon: 'Rule',
    ...
    },
    {
        ...
        name: 'Security',
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/security',
        icon: 'Security',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/taxation/withholding-taxes/system-integration',
