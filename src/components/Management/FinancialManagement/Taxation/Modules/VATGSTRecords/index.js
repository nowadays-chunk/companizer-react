...
export const modules = [
    {
        ...
        type: 'General',
        path: '/apps/taxation/vat-gst-records/register',
        icon: 'Book',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/taxation/vat-gst-records/rules',
        icon: 'RuleFolder',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/taxation/vat-gst-records/input',
        icon: 'Input',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/taxation/vat-gst-records/output',
        icon: 'Output',
    ...
    },
    {
        ...
        name: 'Period Closing',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/closing',
        icon: 'LockClock',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/taxation/vat-gst-records/return',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/taxation/vat-gst-records/adjustments',
        icon: 'Tune',
    ...
    },
    {
        ...
        name: 'Reverse Charge',
        type: 'Specific',
        path: '/apps/taxation/vat-gst-records/reverse-charge',
        icon: 'SwapHoriz',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/taxation/vat-gst-records/international',
        icon: 'Public',
    ...
    },
    {
        ...
        name: 'GL Integration',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/gl',
        icon: 'AccountBalance',
    ...
    },
    {
        ...
        name: 'Reconciliation',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/reconciliation',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        name: 'Reporting',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/reporting',
        icon: 'Assessment',
    ...
    },
    {
        ...
        name: 'Audit Support',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/audit',
        icon: 'SupportAgent',
    ...
    },
    {
        ...
        name: 'Workflow',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/workflow',
        icon: 'LinearScale',
    ...
    },
    {
        ...
        name: 'Automation',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/automation',
        icon: 'AutoFixHigh',
    ...
    },
    {
        ...
        name: 'Status Monitor',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/status',
        icon: 'MonitorHeart',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/taxation/vat-gst-records/integration',
        icon: 'Hub',
    ...
    },
    {
        ...
        name: 'Data Integrity',
        type: 'General',
        path: '/apps/taxation/vat-gst-records/integrity',
