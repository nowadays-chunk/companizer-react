...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/structure',
        icon: 'AccountTree',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/rules',
        icon: 'Rule',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/budget/budget-allocations/time-based',
        icon: 'DateRange',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/controls',
        icon: 'GppGood',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/budget/budget-allocations/revisions',
        icon: 'EditNote',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/tracking',
        icon: 'TrackChanges',
    ...
    },
    {
        ...
        name: 'Consolidation',
        type: 'General',
        path: '/financial-management/budget/budget-allocations/consolidation',
        icon: 'CallMerge',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/workflow',
        icon: 'Approval',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/planning',
        icon: 'NextPlan',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/analytics',
        icon: 'Analytics',
    ...
    },
    {
        ...
        name: 'Encumbrances',
        type: 'Specific',
        path: '/financial-management/budget/budget-allocations/encumbrances',
        icon: 'Lock',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/calendars',
        icon: 'CalendarMonth',
    ...
    },
    {
        ...
        name: 'Audit Controls',
        type: 'General',
        path: '/financial-management/budget/budget-allocations/audit',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        name: 'Automation',
        type: 'General',
        path: '/financial-management/budget/budget-allocations/automation',
        icon: 'AutoMode',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/productivity',
        icon: 'Speed',
    ...
    },
    {
        ...
        name: 'Security',
        type: 'General',
        path: '/financial-management/budget/budget-allocations/security',
        icon: 'Security',
    ...
    },
    {
        ...
        name: 'Integration',
        type: 'General',
        path: '/financial-management/budget/budget-allocations/integration',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/budget-allocations/advanced',
        icon: 'Stars',
