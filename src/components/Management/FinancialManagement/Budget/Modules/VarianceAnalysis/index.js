...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/budget/variance-analysis/calculation',
        icon: 'Calculate',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/budget/variance-analysis/root-cause',
        icon: 'FindInPage',
    ...
    },
    {
        ...
        name: 'Trend Analysis',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/trends',
        icon: 'TrendingUp',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/budget/variance-analysis/revenue',
        icon: 'AttachMoney',
    ...
    },
    {
        ...
        name: 'Cost Variance',
        type: 'Specific',
        path: '/financial-management/budget/variance-analysis/cost',
        icon: 'MoneyOff',
    ...
    },
    {
        ...
        name: 'Profitability',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/profitability',
        icon: 'QueryStats',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/budget/variance-analysis/operational',
        icon: 'Speed',
    ...
    },
    {
        ...
        name: 'Scorecards',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/scorecards',
        icon: 'Score',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/variance-analysis/corrective-action',
        icon: 'Build',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/variance-analysis/alerts',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/variance-analysis/reports',
        icon: 'Assessment',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/budget/variance-analysis/forecast-integration',
        icon: 'CompareArrows',
    ...
    },
    {
        ...
        name: 'Audit Trail',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/audit',
        icon: 'History',
    ...
    },
    {
        ...
        name: 'Security',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/security',
        icon: 'Security',
    ...
    },
    {
        ...
        name: 'Configuration',
        type: 'General',
        path: '/financial-management/budget/variance-analysis/configuration',
        icon: 'Settings',
