...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/dashboard',
        icon: 'Dashboard',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/config',
        icon: 'Settings',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/rates',
        icon: 'TrendingUp',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/entry',
        icon: 'Input',
    ...
    },
    {
        ...
        name: 'FX Revaluation',
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/revaluation',
        icon: 'Autorenew',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/realized-fx',
        icon: 'AttachMoney',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/reporting',
        icon: 'Assessment',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/reconciliation',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/close',
        icon: 'LockClock',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/intercompany',
        icon: 'Business',
    ...
    //     type: 'General',
    //     path: '/financial-management/bank-accounts/foreign-currency-accounts/consolidation',
    //     icon: 'Language',
    ...
    // },
    {
        ...
        type: 'Specific',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/fees',
        icon: 'Receipt',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/controls',
        icon: 'Security',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/audit',
        icon: 'History',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/integration',
    ...
    },
    {
        ...
        type: 'General',
        path: '/financial-management/bank-accounts/foreign-currency-accounts/safeguards',
        icon: 'Shield',
