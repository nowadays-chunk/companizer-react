...
const LoanMasterData = React.lazy(() => import('./LoanMasterData'));
const InterestConfiguration = React.lazy(() => import('./InterestConfiguration'));
const RepaymentSchedule = React.lazy(() => import('./RepaymentSchedule'));
const DisbursementManagement = React.lazy(() => import('./DisbursementManagement'));
const RepaymentProcessing = React.lazy(() => import('./RepaymentProcessing'));
const FeesPenalties = React.lazy(() => import('./FeesPenalties'));
const AccountingGLIntegration = React.lazy(() => import('./AccountingGLIntegration'));
const AccrualsPeriodEnd = React.lazy(() => import('./AccrualsPeriodEnd'));
const LoanModifications = React.lazy(() => import('./LoanModifications'));
const ForeignCurrencyLoans = React.lazy(() => import('./ForeignCurrencyLoans'));
const CovenantsCompliance = React.lazy(() => import('./CovenantsCompliance'));
...
const TreasuryPlanning = React.lazy(() => import('./TreasuryPlanning'));
const IntercompanyLoans = React.lazy(() => import('./IntercompanyLoans'));
const AuditTrailDoc = React.lazy(() => import('./AuditTrailDoc'));
...
export const modules = [
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/master-data',
        icon: 'Description',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/interest-config',
        icon: 'Percent',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/schedule',
        icon: 'CalendarMonth',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/debts/loan-agreements/disbursement',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/debts/loan-agreements/repayment',
        icon: 'Payment',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/debts/loan-agreements/fees',
        icon: 'ReceiptLong',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/accounting',
        icon: 'AccountBalance',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/accruals',
        icon: 'DateRange',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/debts/loan-agreements/modifications',
        icon: 'EditNote',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/new-fx',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/covenants',
        icon: 'GppGood',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/approvals',
        icon: 'Approval',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/status',
        icon: 'DonutLarge',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/reporting',
        icon: 'Insights',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/planning',
        icon: 'ShowChart',
    ...
    },
    {
        ...
        type: 'Specific',
        path: '/apps/debts/loan-agreements/intercompany',
        icon: 'CorporateFare',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/audit',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/security',
        icon: 'Lock',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/integration',
        icon: 'Hub',
    ...
    },
    {
        ...
        type: 'General',
        path: '/apps/debts/loan-agreements/integrity',
        icon: 'Shield',
