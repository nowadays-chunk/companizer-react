...
export const modules = [
    {
        ...
        type: 'General',
        path: '/financial-management/general-ledger/trial-balance/standard',
        icon: 'TableChart',
    ...
    },
    {
        ...
        name: 'Comparative TB',
        type: 'General',
        path: '/financial-management/general-ledger/trial-balance/comparative',
        icon: 'Compare',
    ...
    },
    {
        ...
        name: 'Closing TB',
        type: 'Specific',
        path: '/financial-management/general-ledger/trial-balance/closing',
        icon: 'DoneAll',
    ...
    },
    {
        ...
        name: 'Audit View',
        type: 'Specific',
        path: '/financial-management/general-ledger/trial-balance/audit',
        icon: 'Plagiarism',
    ...
    },
    {
        ...
        name: 'Configuration',
        type: 'General',
        path: '/financial-management/general-ledger/trial-balance/config',
        icon: 'Settings',
