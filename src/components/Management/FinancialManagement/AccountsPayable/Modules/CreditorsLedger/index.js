...
export const modules = [
    {
        ...
        name: 'Reconciliation',
        type: 'General',
        path: '/financial-management/accounts-payable/creditors-ledger/reconciliation',
        icon: 'FactCheck',
    ...
    },
    {
        ...
        name: 'Cash Forecast',
        type: 'General',
        path: '/financial-management/accounts-payable/creditors-ledger/cash-forecast',
        icon: 'RequestQuote',
    ...
    },
    {
        ...
        name: 'DPO Analytics',
        type: 'General',
        path: '/financial-management/accounts-payable/creditors-ledger/dpo-analytics',
        icon: 'InsertChart',
    ...
    },
    {
        ...
        name: 'Disputes',
        type: 'Specific',
        path: '/financial-management/accounts-payable/creditors-ledger/disputes',
        icon: 'ReportProblem',
    ...
    },
    {
        ...
        name: 'Aging Analysis',
        type: 'General',
        path: '/financial-management/accounts-payable/creditors-ledger/aging-analysis',
        icon: 'History',
